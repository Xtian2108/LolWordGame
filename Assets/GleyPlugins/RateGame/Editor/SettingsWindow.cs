namespace GleyRateGame
{
    ...
    public class SettingsWindow : EditorWindow
    {
        ...
        {
            SettingsWindow window = (SettingsWindow)GetWindow(typeof(SettingsWindow), true, "Rate Game Settings Window - v.1.1.0");
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("No Codding Support:", EditorStyles.boldLabel);
